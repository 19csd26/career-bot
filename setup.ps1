...
Register-BotTask -Name "CareerBot-Index0Bridge" -Script "$RepoDir\index0_watcher.py"

Write-Host ""
Write-Host "All 3 services are running and will auto-start on every login."
Write-Host ""
Write-Host "  CareerBot-TelegramBot  — Telegram bot"
Write-Host "  CareerBot-LCWatcher    — watches ~/LeetCode, auto-commits to GitHub"
Write-Host "  CareerBot-Index0Bridge — syncs Index 0 completions → ~/LeetCode"
Write-Host ""
Write-Host "Logs:"
Write-Host "  Get-Content $LogDir\telegram_bot_error.log -Wait"
Write-Host "  Get-Content $LogDir\lc_watcher_error.log -Wait"
Write-Host "  Get-Content $LogDir\index0_watcher_error.log -Wait"
Write-Host ""
